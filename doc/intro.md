...
- [entity-core](#entity-core)
    - [Define Scalars](#define-scalars)
    - [Define Enums](#define-enums)
    - [Define Entities](#define-entities)
    - [Defining Keys](#defining-keys)
    - [The Mighty (aggregate)](#the-mighty-aggregate)
    - [I/O Mechanisms](#io-mechanisms)
...
bindings. Can be used with [`entity-sql`](https://github.com/inqwell/entity-sql) when the
persistence mechanism is a SQL database. Uses [`typeops`](https://github.com/inqwell/typeops)
to maintain purity of domain type instances.
...
![Runtime Structure](aggregate.png "Relationship Structure")
